...
```{r tailoring data to search effort}
...
#number of surveys per month in 2022 - BWS
...
#Number of surveys per month 2022 - BWS & DMS
...
```{r tailoring data - lighting schedule}
