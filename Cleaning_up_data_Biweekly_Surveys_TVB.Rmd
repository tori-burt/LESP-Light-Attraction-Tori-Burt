---
title: "Cleaning_up_data_Biweekly_Surveys_TVB"
author: "Tori Burt"
date: "2023-08-31"
...
#load data
tb1 <- read.csv("data/Fishplant_Rounds_2022_TB_2023_09_02.csv")
...
tb1 <- select(tb1, Date, Time, Plant_lights, Total_LESP_per_night, Live_LESP_per_night, Dead_LESP_per_night, Dead_adults, Live_adults, Dead_breeding_adults, Dead_nonbreeders, Live_juveniles, Dead_juveniles, Fog_Cat, CloudCover_Cat, yDate, Month, Lunar, Year, Wind_Speed, Wind_Direction, Weather_Conditions)

#save the data file
save(tb1, file = "Data_BWS.Rda")
